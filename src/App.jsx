...
import WeatherList from './components/WeatherForecast/WeatherForecast.jsx'; //Importing the weatherList from the WeatherForecast.jsx
import './App.css' //Importing the App.css that contains the styling, removing this just makes it left-aligned

function App() {

//here is a pre-made weatherForecast starter code, I just copy pasted
    ...
    <>
      <h1>Local Weather</h1>
        <section>
            ...
            {/* Here is what confuses me the most, the map part */}
